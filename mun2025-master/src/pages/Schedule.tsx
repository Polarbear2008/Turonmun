...
const scheduleData: ScheduleDay[] = [
  {
    ...
    events: [
      ...
      { 
        ...
        category: 'general',
        description: 'Official opening of FPSMUN 2025 with keynote speeches from distinguished guests and organizing committee.'
      },
      { 
        time: '12:00 - 13:30', 
        title: 'Lunch Break', 
  ...
  },
  {
    ...
    events: [
      ...
      { 
        ...
        location: 'Grand Auditorium',
        category: 'general',
        description: 'Official closing of FPSMUN 2025 with awards presentation, closing speeches, and recognition of participants.'
      },
      { 
        time: '19:00 - 23:00', 
          ...
          <div className="container relative z-10">
            ...
            >
              ...
              <p className="text-xl text-diplomatic-100 max-w-2xl">
                Plan your FPSMUN experience with our comprehensive schedule of committee sessions, 
