    ...
    <header className="glass-nav border-b border-white/10 px-4 md:px-6 py-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          {/* Notifications */}
          <motion.button
            className="relative w-10 h-10 flex items-center justify-center rounded-lg text-white/70 hover:text-white hover:bg-white/10 transition-colors border border-white/5"
          ...
          >
            ...
            {/* Notification Badge */}
            <span className="absolute top-1.5 right-1.5 h-3.5 w-3.5 bg-red-500 text-white text-[10px] font-bold rounded-full flex items-center justify-center border-2 border-diplomatic-900 shadow-lg">
              3
            </span>
          </motion.button>
