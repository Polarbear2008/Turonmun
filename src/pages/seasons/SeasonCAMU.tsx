  ...
  return (
    <PageLayout>
      <motion.div
        ...
        className="bg-gradient-to-b from-white to-gold-50"
      >
        {/* Hero Section - Partnership Theme */}
        <section className="relative py-24 md:py-32 overflow-hidden bg-gradient-to-r from-gold-600 to-gold-800">
          {/* Background Pattern */}
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            >
              <Link 
                to="/past-conferences" 
                className="inline-flex items-center text-white hover:text-gold-100 transition-colors"
              >
            ...
            <div className="max-w-4xl mx-auto text-center">
              ...
              <motion.p 
                className="text-lg md:text-xl text-gold-100 mb-4"
              ...
              >
                <motion.div variants={itemVariants} className="mb-16">
                  <div className="flex items-center justify-center mb-6">
                    <div className="h-0.5 w-10 bg-gold-200 rounded-full mr-4"></div>
                    <h2 className="text-gold-600 font-semibold text-lg uppercase tracking-wider">Overview</h2>
                    <div className="h-0.5 w-10 bg-gold-200 rounded-full ml-4"></div>
                  </div>
                  ...
                  <div className="prose prose-lg max-w-none">
                    ...
                    <div className="bg-gradient-to-r from-gold-50 to-gold-100 p-6 rounded-xl shadow-sm border border-gold-200 mb-8">
                      <h4 className="font-semibold text-lg text-center mb-4 text-gold-800">Season Highlights</h4>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {seasonData.highlights.map((highlight, index) => (
                          <div key={index} className="flex items-start">
                            <div className="flex-shrink-0 h-5 w-5 text-gold-600 mt-0.5">
                    ...
                    <div className="grid md:grid-cols-4 gap-6 mt-12">
                      <div className="bg-gradient-to-br from-white to-gold-50 p-6 rounded-xl shadow-sm border border-gold-100 hover:shadow-md transition-shadow duration-300">
                        <div className="w-14 h-14 bg-gradient-to-br from-gold-500 to-gold-700 rounded-full flex items-center justify-center mb-4 mx-auto text-white">
                          <Users size={24} />
                        </div>
        ...
        {/* Experience Section */}
        <section className="relative py-20 bg-gradient-to-b from-gold-900 to-gold-800 overflow-hidden">
          {/* Decorative elements */}
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center mb-16">
              <motion.h2 
                ...
                className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-gold-200 via-gold-100 to-gold-300 bg-clip-text text-transparent"
              >
                {seasonData.theme}
              </motion.h2>
              <motion.p 
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.6, delay: 0.1 }}
                className="text-xl text-gold-200 leading-relaxed font-light max-w-3xl mx-auto"
              >
          ...
          {/* Gradient divider */}
          <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-gold-900 to-transparent"></div>
        </section>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold text-gold-800 mb-4">Conference Highlights</h2>
              <div className="w-20 h-1 bg-gold-600 mx-auto mb-6"></div>
              <p className="text-gold-600 max-w-2xl mx-auto">Relive the memorable moments from our historic {seasonData.title} collaboration</p>
            </motion.div>
            ...
            <div className="mt-12 text-center">
              <button className="bg-gold-600 hover:bg-gold-700 text-white font-medium py-3 px-8 rounded-full transition-colors duration-300 inline-flex items-center">
                View All Photos
