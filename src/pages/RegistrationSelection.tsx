                        ...
                        {role.available ? (
                          ...
                          >
                            <div 
                              className="inline-flex items-center justify-center w-full font-semibold py-4 px-8 rounded-2xl transition-all duration-300 backdrop-blur-sm"
                              style={{
                                backgroundColor: hoveredButton === `${role.title}-coming` ? '#EAB308' : 'rgba(255, 255, 255, 0.1)',
                                color: hoveredButton === `${role.title}-coming` ? '#000000' : 'rgba(255, 255, 255, 0.5)',
                                borderColor: hoveredButton === `${role.title}-coming` ? '#EAB308' : 'rgba(255, 255, 255, 0.2)',
                                borderWidth: '1px',
                                borderStyle: 'solid'
                              }}
                              onMouseEnter={() => setHoveredButton(`${role.title}-coming`)}
                              onMouseLeave={() => setHoveredButton(null)}
                            >
                              Coming Soon
                            </div>
