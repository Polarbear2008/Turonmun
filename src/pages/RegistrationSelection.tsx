...
const RegistrationSelection = () => {
  ...
  const roles = [
    {
      title: "Delegate",
      description: "Active participation — Non-refundable application",
      price: "80K UZS",
      date: "Deadline: March 21, 2026",
      spots: "80 spots",
      available: true,
    ...
    },
    {
      ...
      price: "FREE",
      date: "Deadline: March 8, 2026",
      spots: "4 chairs, 4 co-chairs",
      available: true,
      route: "https://forms.gle/XLwTAz3PpyvsgFW1A",
      location: "Registan Private School"
    },
    {
      title: "Observer",
      description: "Relaxed participation — Non-refundable application",
      price: "80K UZS",
      date: "Deadline: March 21, 2026",
      spots: "20 spots",
      available: true,
      route: "https://forms.gle/auLrmoit4fiFu3Yq6"
    }
  ];
            ...
            <div className="w-full max-w-6xl">
              ...
              >
                ...
                <p className="text-xl text-white/80 max-w-3xl mx-auto">
                  Select your participation type for TuronMUN 2026. Each role offers a unique diplomatic experience.
                </p>
              </motion.div>
