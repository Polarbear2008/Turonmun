        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              ...
              {/* Social Login */}
              <button className="w-full py-3 rounded-lg border border-neutral-200 hover:bg-neutral-50 transition-colors flex items-center justify-center gap-2 text-neutral-700 font-medium">
